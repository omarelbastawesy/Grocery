        ...
        <div className="flex flex-col md:flex-row items-center justify-evenly gap-8 bg-white p-5 md:p-8 rounded-lg mb-8">
          ...
          <div className="">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                disabled={meal?.meal.stock_quantity < 1}
                className="cursor-pointer bg-[#014162] text-white px-6 py-4 rounded-lg flex items-center justify-center gap-2 hover:bg-[#014162]/80 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <ShoppingCart className="w-5 h-5" />
                Add To Cart
              </button>
              <button className="cursor-pointer sm:flex-none bg-gray-300 text-gray-700 px-6 py-4 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-400">
